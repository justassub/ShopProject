...
var AutoComplete = exports.AutoComplete = function (_Component) {
    ...
    _createClass(AutoComplete, [{
        ...
        value: function formatValue(value) {
            if (value) return this.props.field ? _ObjectUtils2.default.resolveFieldData(value, this.props.field) || value : value;else return '';
        }
    }, {
        ...
        value: function showPanel() {
            if (this.focus) {
                ...
                if (this.panel && this.panel.element && !this.panel.element.offsetParent) {
                    this.panel.element.style.zIndex = _DomHandler2.default.getZindex();
